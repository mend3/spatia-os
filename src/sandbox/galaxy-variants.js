...
const SINGLE = {
  ...
  watch: [
    ...
    '⚠️ VOLUME — de perfil o objeto tem de ter TRÊS camadas visíveis ao mesmo tempo: uma faixa fina e brilhante (o disco fino), um NÚCLEO REDONDO que sobra dela para cima e para baixo (o bojo é um esferoide, não uma folha), e um brilho mais gordo e fraco envolvendo os dois (o disco espesso). Se o núcleo achatar junto com a faixa, o bojo voltou a ser lido na coordenada do disco — que era o defeito "as galáxias estão flat" inteiro, num símbolo só.',
    '⚠️ orbite de frente até o perfil e olhe o BRILHO TOTAL. O objeto pode escurecer ~3x, nunca ~10x. Antes de 2026-08-06 ele apagava: cada componente perdia luz pelo próprio achatamento e nada segurava o fluxo. Quem segura agora é o disco espesso, que é opticamente FINO e por isso ganha a coluna quase inteira (~5x) em vez de saturar em 1,986x como o fino.',
    'DE FRENTE (pose cos ~1) a imagem tem de ser IDÊNTICA à de antes do disco espesso existir — os três aspectos valem 1, as três coordenadas coincidem e o 1/(1-FRAC_ESPESSO) no armMod cancela a fração que saiu do disco fino. É verificável por screenshot A/B com `git stash`; foi assim que entrou.',
    '⚠️ com DUST alto e o corpo inclinado (pose cos ~0,3 a 0,6), metade do bojo tem de ficar mais escura que a outra — a poeira do plano médio passa na FRENTE da metade de trás. A metade escura é a do lado que está mais PERTO de você. Se as duas metades tiverem o mesmo brilho, o objeto ficou gordo mas continua sem frente e fundo. DUST a 0 tem de devolver as duas iguais.',
