...
> (o fail-open da §2.8) e **13** (teto de custo diário e concorrência — `server/budget.py`). Parciais: **3** (órbita vem do manifesto, mas é literal por app e ainda
...
> (`#/bridge` sem credenciais, que dependem do 18). Os outros oito estão abertos. O que está
